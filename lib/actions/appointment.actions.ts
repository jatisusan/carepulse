...
export const updateAppointment = async ({ userId, appointmentId, appointment, type }: UpdateAppointmentParams) => {
    try {
        ...
        const smsMessage = `[Carepulse] \n${type === 'schedule'
            ...
            : `We regret to inform you that your appointment for ${formatDateTime(appointment.schedule).dateTime} has been cancelled.\nReason: ${appointment.cancellationReason}.\nWe'd be happy to help you reschedule.`
        }`;
